...
<div>
  ...
  <div class="md-layout" v-bind:style="style_list()"  >
        ...
        <md-card-content>
          ...
          <div class="md-layout">
              ...
              <div class="md-layout-item md-size-30 md-xsmall-size-100">
                   ...
                   <md-button
                  title="Exportar CSV"
                  class="md-round md-just-icon md-success pull-right"
    ...
    <div v-if="action =='form'" >
         <technical_information_form  v-bind:id_load="form.id" 
          v-bind:onSave="onSave" 
          show_back_button="true" v-bind:onBack="onBack"></technical_information_form>
     </div>
</div>
</template>
...
import technical_information_form from "./Form";
...
import ExportData from "../../../library/ExportData";

import Responsive from 'datatables.net-responsive';
require( 'datatables.net-buttons' )( window, $ ); //buttons.html5
require( 'datatables.net-buttons/js/buttons.html5.min.js' )( window, $ ); //buttons.html5

export default {
  components: {
      technical_information_form,
       filtro_simples
  },
  computed: {
  },
  ...
  methods: {
    ...
    onSave(ret, acao){
      ...
      if (acao == "save") {
        Alerta.show(
          "Sucesso!",
          "technical_information salvo com sucesso!",
          "success",
          null,
          3000
        );
        ...
        Alerta.show(
          "Sucesso!",
          "technical_information removido com sucesso!",
          "success",
          function() {},
          3000
        );
      ...
      if ( this.table == null ){
           ...
           var table = $(self.$refs["table_data"]).DataTable( {
                  ...
                  buttons: [ 
                        {
                          extend: 'csv',
                          filename: 'export_technical_information',
                          extension: '.csv',
                          fieldSeparator: ";",
                          charset: "utf-8",
                          fieldBoundary: "",
                          customize: function(output, config, dt){
                                /* [{index: 3, format: "date"}, {index: 4, format: "date"}] */
                                       return ExportData.exportCSVFromDtTable(output, config, dt);
                          }
                        }
                   ],
                  columns: [
    ...
    clean_back_button(){
            ...
            this.$store.dispatch("setButtonBack", { in_form: false,
