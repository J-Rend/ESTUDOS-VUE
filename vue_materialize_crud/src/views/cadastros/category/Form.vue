          ...
          <md-card-content>
            <div class="md-layout">
              ...
              <label>Descrição</label>
                  <md-input name="description" type="text" placeholder="Descrição" v-model="form.description" maxlength="300"></md-input>
                </md-field>

                <span class="error_input">{{ getErrors('description') }}</span>
              </div>
    ...
    salvar() {
      ...
      service
        ...
        .then(function(response) {
          ...
          self.message_text = "Categoria salva com sucesso!";
